        ...
        <div className="login-wrapper">
            <div className="container">
                <div className="login-panel">
                    <h4>Zarejestruj się, aby robić zakupy w naszym sklepie</h4>
                    <form onSubmit={(e) => Register_(e)}>
                        <div>
                            <label style={{display: "block", width: "100%"}} htmlFor="login">Podaj nazwę użytkownika:</label>
                        ...
                        <div>
                            <label style={{display: "block", width: "100%"}} className="repassword" htmlFor="re">Powtórz hasło:</label>
